...
import { TurmaInterface } from "../interfaces";
  ...
  return (
    <div className="py-3">
      ...
      {loading ? (
        ...
        <p className="text-muted">Você não está matriculado em nenhuma turma.</p>
      ) : (
        <Row className="g-3">
          {turmas.map(t => (
              ...
              <Card className="h-100 border-0 shadow-sm">
                <Card.Body>
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    <Card.Title className="mb-0" style={{ fontSize: "1rem" }}>{t.nome}</Card.Title>
