...
export default function ProfessorMinhasTurmas() {
            ...
            <Col key={t.id_turma} xs={12} sm={6} md={4}>
              <Card className="h-100 border-0 shadow-sm">
                <Card.Body>
                  ...
                  <p className="text-muted mb-1" style={{ fontSize: "13px" }}>🕐 {t.horario} · {t.dia_semana}</p>
                  <p className="text-muted mb-0" style={{ fontSize: "13px" }}>👥 {t.alunos?.length ?? 0} aluno(s)</p>
                </Card.Body>
              </Card>
            </Col>
          ))}
