...
// ── Meu Perfil (aluno logado) ─────────────────────────────────────────────
// Qualquer perfil autenticado pode acessar seus próprios dados
...
router.patch ("/alunos/:id/inativar",     auth.hasAuthorization, auth.isAdmin, alunoController.inativar);
